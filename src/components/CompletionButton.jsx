...
import { getUserProgress, markPageComplete } from '../api/user.api';
  ...
  if (completed) {
    return (
      <motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        className="flex items-center justify-center gap-2 px-6 py-4 bg-green-500/20 backdrop-blur-sm border border-green-400/30 text-green-200 rounded-lg"
      >
